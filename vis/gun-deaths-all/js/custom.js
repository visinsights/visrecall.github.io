...
width = 762,
height = 640,
margin = {top: 10, right: 80, bottom: 180, left: 10},
maxDeaths = 33599,
yMax = 150,
initOne = false,
initAll = false;
...
var x = d3.scaleLinear()
	...
	colorLight = d3.scaleOrdinal()
				.domain(["Suicide", "Homicide", "Police", "Accidental", "Undetermined"])
				.range(["rgba(229, 83, 55, 0.3)", "rgba(37, 136, 116, 0.3)", "rgba(37, 136, 116, 0.3)", "rgba(97, 126, 237, 0.3)", "rgba(97, 126, 237, 0.3)"]);
...
function annotateSection(classes, yAdjust = 0, xAdjust = 0, text2, text1 = ""){
	lineheight = 16
	y0 = 470
...
var steps = [
	...
	function step3() {
		...
		annotateSection(".Homicide, .Police", 0, 0, "Suicides");
	},
	function step4() {
		...
		annotateSection(".Homicide, .Police", 0, 0, "Suicides");
		annotateSection(".Homicide, .Police, .Suicide.Female", 1, 0, "Male Suicides");
	},
	function step5() {
		dataContainer.selectAll('.Suicide')
				.attr('fill', 'rgba(229, 83, 55, 0.4)');
		...
		annotateSection(".Homicide, .Police", 0, 0, "Suicides");
		annotateSection(".Homicide, .Police, .Suicide.Female", 1, 0, "Male Suicides");
		annotateSection(".Homicide, .Police, .Suicide.Female, .Suicide.Male._Under15, .Suicide.Male._15to34", 2, 0, "Male Suicides", "35 and above");
	},
	function step6() {
		...
		annotateSection(".Homicide", 0, -1, "Homicides");
	},
	function step7() {
		...
		annotateSection(".Homicide", 0, -1, "Homicides");
		annotateSection(".Homicide.Female, .Homicide.Male._Under15, .Homicide.Male._15to34", 1, -1, "Homicides", "Young Male");
	},
	function step8() {          
		dataContainer.selectAll('.Homicide')
				.attr('fill', "rgba(93, 215, 188, 0.4)");
		...
		annotateSection(".Homicide", 0, -1, "Homicides");
		annotateSection(".Homicide.Female, .Homicide.Male._Under15, .Homicide.Male._15to34", 1, -1, "Homicides", "Young Male");
		annotateSection(".Homicide.Female, .Homicide.Male._Under15.Black, .Homicide.Male._15to34.Black", 2, -1, "Male Homicides", "Young Black");
	},
	function step9() {
		dataContainer.selectAll('.Homicide')
				.attr('fill', "rgba(93, 215, 188, 0.4)");
		...
		annotateSection(".Homicide", 0, -1, "Homicides");
		annotateSection(".Homicide.Female", 1, 0, "Female Homicides");
	},
	function step10() {
		...
		drawCanvas();
		annotateSection(".Homicide, .Police, .Suicide", 2, -1, "Undetermined", "Accidents or");
	},
	function step11() {
		dataContainer.selectAll('custom')
				.attr('fill', 'rgba(74, 74, 74, 0.2)');
...
function loadData(gender = '', age = '', race = '', intent = ''){
	...
	if (annotate){
		...
		annotateSection(".Homicide, .Police", 2, 0, "Suicides");
		annotateSection(".Homicide, .Police, .Suicide", 2, 0, "Undetermined", "Accidents or");
	}
}
